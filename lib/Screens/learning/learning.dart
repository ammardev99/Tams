...
class _LearningState extends State<Learning> {
  ...
  Widget build(BuildContext context) {
      ...
      body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              // coursePkg("Tour Name", "assets/course_images/web.png", context,
              //     const ServiceIntro()),
              Padding(
    ...
    child: InkWell(
      ...
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => const ServiceIntro()));
      },
      // main container
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8),
                  image: const DecorationImage(
                    image: AssetImage('assets/course_images/web.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    heading('Tour Name', secondaryColor),
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ServiceIntro()),
                      );
                    },
                    // main container
                    child: Stack(children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(
                                    width: 1, color: secondaryColor03),
                                borderRadius: BorderRadius.circular(8),
                                image: const DecorationImage(
                                  image:
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  heading('1 Day Tour', secondaryColor),
                                  const Text(
